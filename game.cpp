...
void UIPlay::drawRecTangle(sf::RenderWindow& window, float x, float y, sf::Color color, float sizeWidth, float sizeHight) {
...
void UIPlay::drawDashBoard(sf::RenderWindow& window, sf::Font font)
{
